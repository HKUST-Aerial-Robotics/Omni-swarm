...
enum DisplayMode
{
  ...
  /*! In hotpoint mode */
  MODE_HOTPOINT_MODE =
    DJI::OSDK::VehicleStatus::DisplayMode::MODE_HOTPOINT_MODE,
  /*! In this mode, user can push the throttle
   * stick to complete stable take-off. */
  MODE_ASSISTED_TAKEOFF =
    DJI::OSDK::VehicleStatus::DisplayMode::MODE_ASSISTED_TAKEOFF,
  ...
  MODE_NAVI_SDK_CTRL =
    DJI::OSDK::VehicleStatus::DisplayMode::MODE_NAVI_SDK_CTRL,

  /*! drone is forced to land, might due to low battery */
  MODE_FORCE_AUTO_LANDING =
    DJI::OSDK::VehicleStatus::DisplayMode::MODE_FORCE_AUTO_LANDING,
...
{
  M100_STATUS_ON_GROUND =
    DJI::OSDK::VehicleStatus::M100FlightStatus::ON_GROUND_STANDBY,
