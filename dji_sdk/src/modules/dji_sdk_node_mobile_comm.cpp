...
void
DJISDKNode::SDKfromMobileDataCallback(Vehicle* vehicle, RecvContainer recvFrame,
...
void
DJISDKNode::fromMobileDataCallback(RecvContainer recvFrame)
{
...
bool
DJISDKNode::sendToMobileCallback(dji_sdk::SendMobileData::Request&  request,
