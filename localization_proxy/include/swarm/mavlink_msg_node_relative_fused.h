...
typedef struct __mavlink_node_relative_fused_t {
 ...
 int16_t rel_yaw_offset; /*< [deg] Relative Yaw coorinate offset *10*/
 uint8_t target_id; /*<  Target ID of drone*/
}) mavlink_node_relative_fused_t;

#define MAVLINK_MSG_ID_NODE_RELATIVE_FUSED_LEN 9
#define MAVLINK_MSG_ID_NODE_RELATIVE_FUSED_MIN_LEN 9
#define MAVLINK_MSG_ID_401_LEN 9
#define MAVLINK_MSG_ID_401_MIN_LEN 9

#define MAVLINK_MSG_ID_NODE_RELATIVE_FUSED_CRC 210
#define MAVLINK_MSG_ID_401_CRC 210
...
#define MAVLINK_MESSAGE_INFO_NODE_RELATIVE_FUSED { \
    ...
    "NODE_RELATIVE_FUSED", \
    5, \
    {  { "target_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 8, offsetof(mavlink_node_relative_fused_t, target_id) }, \
         { "rel_x", NULL, MAVLINK_TYPE_INT16_T, 0, 0, offsetof(mavlink_node_relative_fused_t, rel_x) }, \
         { "rel_y", NULL, MAVLINK_TYPE_INT16_T, 0, 2, offsetof(mavlink_node_relative_fused_t, rel_y) }, \
         { "rel_z", NULL, MAVLINK_TYPE_INT16_T, 0, 4, offsetof(mavlink_node_relative_fused_t, rel_z) }, \
         { "rel_yaw_offset", NULL, MAVLINK_TYPE_INT16_T, 0, 6, offsetof(mavlink_node_relative_fused_t, rel_yaw_offset) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_NODE_RELATIVE_FUSED { \
 ...
 * @param rel_yaw_offset [deg] Relative Yaw coorinate offset *10
...
static inline uint16_t mavlink_msg_node_relative_fused_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_id, int16_t rel_x, int16_t rel_y, int16_t rel_z, int16_t rel_yaw_offset)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_NODE_RELATIVE_FUSED_LEN];
    _mav_put_int16_t(buf, 0, rel_x);
    _mav_put_int16_t(buf, 2, rel_y);
    _mav_put_int16_t(buf, 4, rel_z);
    _mav_put_int16_t(buf, 6, rel_yaw_offset);
...
{
    return mavlink_msg_node_relative_fused_pack(system_id, component_id, msg, node_relative_fused->target_id, node_relative_fused->rel_x, node_relative_fused->rel_y, node_relative_fused->rel_z, node_relative_fused->rel_yaw_offset);
}
...
{
    return mavlink_msg_node_relative_fused_pack_chan(system_id, component_id, chan, msg, node_relative_fused->target_id, node_relative_fused->rel_x, node_relative_fused->rel_y, node_relative_fused->rel_z, node_relative_fused->rel_yaw_offset);
}
...
static inline void mavlink_msg_node_relative_fused_send(mavlink_channel_t chan, uint8_t target_id, int16_t rel_x, int16_t rel_y, int16_t rel_z, int16_t rel_yaw_offset)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_NODE_RELATIVE_FUSED_LEN];
    _mav_put_int16_t(buf, 0, rel_x);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_node_relative_fused_send(chan, node_relative_fused->target_id, node_relative_fused->rel_x, node_relative_fused->rel_y, node_relative_fused->rel_z, node_relative_fused->rel_yaw_offset);
#else
 ...
 */
static inline void mavlink_msg_node_relative_fused_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_id, int16_t rel_x, int16_t rel_y, int16_t rel_z, int16_t rel_yaw_offset)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 *
 * @return [deg] Relative Yaw coorinate offset *10
 */
