...
#define MAVLINK_MSG_ID_NODE_DETECTED_LEN 21
#define MAVLINK_MSG_ID_NODE_DETECTED_MIN_LEN 21
#define MAVLINK_MSG_ID_403_LEN 21
#define MAVLINK_MSG_ID_403_MIN_LEN 21

#define MAVLINK_MSG_ID_NODE_DETECTED_CRC 60
#define MAVLINK_MSG_ID_403_CRC 60
...
#define MAVLINK_MESSAGE_INFO_NODE_DETECTED { \
    ...
    "NODE_DETECTED", \
    11, \
    {  { "target_id", NULL, MAVLINK_TYPE_INT8_T, 0, 20, offsetof(mavlink_node_detected_t, target_id) }, \
         { "x", NULL, MAVLINK_TYPE_INT16_T, 0, 0, offsetof(mavlink_node_detected_t, x) }, \
         { "y", NULL, MAVLINK_TYPE_INT16_T, 0, 2, offsetof(mavlink_node_detected_t, y) }, \
         { "z", NULL, MAVLINK_TYPE_INT16_T, 0, 4, offsetof(mavlink_node_detected_t, z) }, \
         { "corx", NULL, MAVLINK_TYPE_INT16_T, 0, 6, offsetof(mavlink_node_detected_t, corx) }, \
         { "cory", NULL, MAVLINK_TYPE_INT16_T, 0, 8, offsetof(mavlink_node_detected_t, cory) }, \
         { "corz", NULL, MAVLINK_TYPE_INT16_T, 0, 10, offsetof(mavlink_node_detected_t, corz) }, \
         { "q0", NULL, MAVLINK_TYPE_INT16_T, 0, 12, offsetof(mavlink_node_detected_t, q0) }, \
         { "q1", NULL, MAVLINK_TYPE_INT16_T, 0, 14, offsetof(mavlink_node_detected_t, q1) }, \
         { "q2", NULL, MAVLINK_TYPE_INT16_T, 0, 16, offsetof(mavlink_node_detected_t, q2) }, \
         { "q3", NULL, MAVLINK_TYPE_INT16_T, 0, 18, offsetof(mavlink_node_detected_t, q3) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_NODE_DETECTED { \
...
static inline uint16_t mavlink_msg_node_detected_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               int8_t target_id, int16_t x, int16_t y, int16_t z, int16_t corx, int16_t cory, int16_t corz, int16_t q0, int16_t q1, int16_t q2, int16_t q3)
{
    ...
    _mav_put_int16_t(buf, 6, corx);
    _mav_put_int16_t(buf, 8, cory);
    _mav_put_int16_t(buf, 10, corz);
    _mav_put_int16_t(buf, 12, q0);
    _mav_put_int16_t(buf, 14, q1);
    _mav_put_int16_t(buf, 16, q2);
    _mav_put_int16_t(buf, 18, q3);
    _mav_put_int8_t(buf, 20, target_id);
...
{
    return mavlink_msg_node_detected_pack(system_id, component_id, msg, node_detected->target_id, node_detected->x, node_detected->y, node_detected->z, node_detected->corx, node_detected->cory, node_detected->corz, node_detected->q0, node_detected->q1, node_detected->q2, node_detected->q3);
}
...
{
    return mavlink_msg_node_detected_pack_chan(system_id, component_id, chan, msg, node_detected->target_id, node_detected->x, node_detected->y, node_detected->z, node_detected->corx, node_detected->cory, node_detected->corz, node_detected->q0, node_detected->q1, node_detected->q2, node_detected->q3);
}
...
static inline void mavlink_msg_node_detected_send(mavlink_channel_t chan, int8_t target_id, int16_t x, int16_t y, int16_t z, int16_t corx, int16_t cory, int16_t corz, int16_t q0, int16_t q1, int16_t q2, int16_t q3)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_NODE_DETECTED_LEN];
    _mav_put_int16_t(buf, 0, x);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_node_detected_send(chan, node_detected->target_id, node_detected->x, node_detected->y, node_detected->z, node_detected->corx, node_detected->cory, node_detected->corz, node_detected->q0, node_detected->q1, node_detected->q2, node_detected->q3);
#else
 ...
 */
static inline void mavlink_msg_node_detected_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  int8_t target_id, int16_t x, int16_t y, int16_t z, int16_t corx, int16_t cory, int16_t corz, int16_t q0, int16_t q1, int16_t q2, int16_t q3)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
