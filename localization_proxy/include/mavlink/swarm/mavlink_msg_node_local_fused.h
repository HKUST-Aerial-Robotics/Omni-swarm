...
#define MAVLINK_MSG_ID_NODE_LOCAL_FUSED_LEN 13
#define MAVLINK_MSG_ID_NODE_LOCAL_FUSED_MIN_LEN 13
#define MAVLINK_MSG_ID_207_LEN 13
#define MAVLINK_MSG_ID_207_MIN_LEN 13

#define MAVLINK_MSG_ID_NODE_LOCAL_FUSED_CRC 65
#define MAVLINK_MSG_ID_207_CRC 65
...
#define MAVLINK_MESSAGE_INFO_NODE_LOCAL_FUSED { \
    ...
    {  { "lps_time", NULL, MAVLINK_TYPE_INT32_T, 0, 0, offsetof(mavlink_node_local_fused_t, lps_time) }, \
         { "target_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 12, offsetof(mavlink_node_local_fused_t, target_id) }, \
...
static inline uint16_t mavlink_msg_node_local_fused_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               int32_t lps_time, uint8_t target_id, int16_t x, int16_t y, int16_t z, int16_t yaw)
{
...
{
    return mavlink_msg_node_local_fused_pack(system_id, component_id, msg, node_local_fused->lps_time, node_local_fused->target_id, node_local_fused->x, node_local_fused->y, node_local_fused->z, node_local_fused->yaw);
}
...
{
    return mavlink_msg_node_local_fused_pack_chan(system_id, component_id, chan, msg, node_local_fused->lps_time, node_local_fused->target_id, node_local_fused->x, node_local_fused->y, node_local_fused->z, node_local_fused->yaw);
}
...
static inline void mavlink_msg_node_local_fused_send(mavlink_channel_t chan, int32_t lps_time, uint8_t target_id, int16_t x, int16_t y, int16_t z, int16_t yaw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_NODE_LOCAL_FUSED_LEN];
    _mav_put_int32_t(buf, 0, lps_time);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_node_local_fused_send(chan, node_local_fused->lps_time, node_local_fused->target_id, node_local_fused->x, node_local_fused->y, node_local_fused->z, node_local_fused->yaw);
#else
 ...
 */
static inline void mavlink_msg_node_local_fused_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  int32_t lps_time, uint8_t target_id, int16_t x, int16_t y, int16_t z, int16_t yaw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
