...
#define MAVLINK_MSG_ID_SWARM_INFO_LEN 65
#define MAVLINK_MSG_ID_SWARM_INFO_MIN_LEN 65
#define MAVLINK_MSG_ID_400_LEN 65
#define MAVLINK_MSG_ID_400_MIN_LEN 65

#define MAVLINK_MSG_ID_SWARM_INFO_CRC 26
#define MAVLINK_MSG_ID_400_CRC 26
...
#define MAVLINK_MESSAGE_INFO_SWARM_INFO { \
    ...
    "SWARM_INFO", \
    8, \
    {  { "odom_vaild", NULL, MAVLINK_TYPE_UINT8_T, 0, 64, offsetof(mavlink_swarm_info_t, odom_vaild) }, \
         ...
         { "vx", NULL, MAVLINK_TYPE_FLOAT, 0, 12, offsetof(mavlink_swarm_info_t, vx) }, \
         { "vy", NULL, MAVLINK_TYPE_FLOAT, 0, 16, offsetof(mavlink_swarm_info_t, vy) }, \
         { "vz", NULL, MAVLINK_TYPE_FLOAT, 0, 20, offsetof(mavlink_swarm_info_t, vz) }, \
         { "remote_distance", NULL, MAVLINK_TYPE_FLOAT, 10, 24, offsetof(mavlink_swarm_info_t, remote_distance) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SWARM_INFO { \
...
static inline uint16_t mavlink_msg_swarm_info_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t odom_vaild, float x, float y, float z, float vx, float vy, float vz, const float *remote_distance)
{
    ...
    _mav_put_uint8_t(buf, 64, odom_vaild);
    _mav_put_float_array(buf, 24, remote_distance, 10);
...
{
    return mavlink_msg_swarm_info_pack(system_id, component_id, msg, swarm_info->odom_vaild, swarm_info->x, swarm_info->y, swarm_info->z, swarm_info->vx, swarm_info->vy, swarm_info->vz, swarm_info->remote_distance);
}
...
{
    return mavlink_msg_swarm_info_pack_chan(system_id, component_id, chan, msg, swarm_info->odom_vaild, swarm_info->x, swarm_info->y, swarm_info->z, swarm_info->vx, swarm_info->vy, swarm_info->vz, swarm_info->remote_distance);
}
...
static inline void mavlink_msg_swarm_info_send(mavlink_channel_t chan, uint8_t odom_vaild, float x, float y, float z, float vx, float vy, float vz, const float *remote_distance)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SWARM_INFO_LEN];
    _mav_put_float(buf, 0, x);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_swarm_info_send(chan, swarm_info->odom_vaild, swarm_info->x, swarm_info->y, swarm_info->z, swarm_info->vx, swarm_info->vy, swarm_info->vz, swarm_info->remote_distance);
#else
 ...
 */
static inline void mavlink_msg_swarm_info_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t odom_vaild, float x, float y, float z, float vx, float vy, float vz, const float *remote_distance)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
{
    return _MAV_RETURN_float_array(msg, remote_distance, 10,  24);
}
