...
#define MAVLINK_MSG_ID_SWARM_REMOTE_COMMAND_LEN 34
#define MAVLINK_MSG_ID_SWARM_REMOTE_COMMAND_MIN_LEN 34
...
{
    return mavlink_msg_swarm_remote_command_pack(system_id, component_id, msg, swarm_remote_command->target_id, swarm_remote_command->command_type, swarm_remote_command->param1, swarm_remote_command->param2, swarm_remote_command->param3, swarm_remote_command->param4, swarm_remote_command->param5, swarm_remote_command->param6, swarm_remote_command->param7, swarm_remote_command->param8);
}
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_swarm_remote_command_send(chan, swarm_remote_command->target_id, swarm_remote_command->command_type, swarm_remote_command->param1, swarm_remote_command->param2, swarm_remote_command->param3, swarm_remote_command->param4, swarm_remote_command->param5, swarm_remote_command->param6, swarm_remote_command->param7, swarm_remote_command->param8);
#else
